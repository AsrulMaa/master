                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-12">
                                <?= form_input('title', '', ['class'=> 'form-control',  'autofocus' => true, 'onkeyup' => '', 'id'=>'title', 'placeholder' => 'title for article']); ?>
                               <?= form_input('slug', '', ['class'=> 'form-control',  'autofocus' => true, 'id' => 'input-slug', 'style' => 'display:none;']); ?>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-12">
                                <textarea id="content" name="content" rows="8" cols="120" class="form-control" placeholder="Content your article"><?= set_value('Content'); ?></textarea>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                <!-- <select  class="form-control chosen chosen-select-deselect" name="category" id="category" data-placeholder="Select Category" > -->
                                    <!-- <option value=""></option> -->
                                      <?= form_dropdown('id_blog_categories', getDropdownList('blog_categories', ['id', 'categories']), '', ['class' => 'form-control chosen chosen-select-deselect', "data-placeholder"=> "Select Category"]); ?>
                               <!--  </select> -->
                            </div>
                        </div>
                        <div class="row"></div>
...
$(document).ready(function(){
	 $('#blog_image_galery').fineUploader({
        ...
        request: {
            endpoint: BASE_URL + '/admin/blog/upload_image_file',
            params : {
        ...
        deleteFile: {
            enabled: true, 
            endpoint: BASE_URL + '/admin/blog/delete_image_file',
        },
        thumbnails: {
            placeholders: {
                waitingPath: BASE_ASSET  + 'libraries/fine-upload/placeholders/waiting-generic.png',
                notAvailablePath: BASE_ASSET  + 'libraries/fine-upload/placeholders/not_available-generic.png'
            }
        },
        validation: {
